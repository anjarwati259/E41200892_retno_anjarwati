...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE master_pengguna(id integer PRIMARY KEY AUTOINCREMENT, nama text, alamat text, tglLahir text)");
    ...
    public Cursor getDataAll(){
        ...
        return db.rawQuery("SELECT * FROM master_pengguna", null);
    }
    //check session
